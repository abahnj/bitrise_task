...
class _$PersonTearOff {
  ...
  _Person call({required String name, String? language}) {
    return _Person(
      name: name,
      language: language,
    );
...
abstract class $PersonCopyWith<$Res> {
  ...
  $Res call({String name, String? language});
}
...
class _$_Person implements _Person {
  _$_Person({required this.name, this.language});
...
abstract class _Person implements Person {
  factory _Person({required String name, String? language}) = _$_Person;
